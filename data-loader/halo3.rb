...
#GAMER_TAGS = ['JAN0SIDE']
GAMER_TAGS = ['JAN0SIDE', 'meesturbo', 'bobby1110', 'rcp1000', 'badassmof01234', 'strikebox', 'TITANICKonfuzin']
...
URL_LIST = {
	...
	:game_list => "http://www.bungie.net/Stats/PlayerStatsHalo3.aspx?player=",
	:game_details => "http://www.bungie.net/Stats/GameStatsHalo3.aspx?gameid="
}
